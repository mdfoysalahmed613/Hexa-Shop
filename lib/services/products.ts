...
export interface ProductVariant {
  ...
  attributes: Record<string, string>; // JSONB attributes like { "Size": "XL", "Color": "Red" }
 ...
 * - Variants are stored in products_variants table
 */
export async function addProduct(
  ...
  try {
    ...
    // Insert variants into products_variants table
...
export async function updateProduct(
  ...
  try {
    ...
    await supabase.from("products_variants").delete().eq("product_id", id);
...
export async function deleteProduct(id: string): Promise<ActionResult> {
  try {
    ...
    // Delete product (cascades to product_images, products_variants)
    ...
    const { data, error } = await supabase
      ...
      .select(
        ...
        *,
        ...
        variants:products_variants(id, price, compare_price, stock, is_active, variant_name, attributes)
      `
      )
